...
return {
	...
	keys = {
		...
		{ "<leader>fb",  function() require("snacks").picker.buffers() end,      desc = "Open buffers" },
		{ "<leader>fk",  function() require("snacks").picker.keymaps() end,      desc = "Keymaps" },
		{ "<leader>fr",  function() require("snacks").picker.recent() end,      desc = "Open recent files" },
		{ "<leader>fhi", function() require("snacks").picker.highlights() end,      desc = "Open highlights" },
		{ "<leader>ff",  function() require("snacks").picker.files() end,   desc = "Open files" },
		{ "<leader>fc",  function() require("snacks").picker.colorschemes() end, desc = "Change colorscheme" },
		{ "<leader>fd",  function() require("snacks").picker.diagnostics() end,  desc = "Open diagnostics" },
		{ "<leader>fhl", function() require("snacks").picker.help() end,    desc = "Open help" },
