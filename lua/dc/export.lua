...
statusbar.font = 14pt JetBrainsMono Nerd Font
statusbar.bg = ${bg_mid}
statusbar.fg = ${fg}
statusbar.error = ${red}
...
statusbar.padding = 4
thumbnail.font = 14pt JetBrainsMono Nerd Font
thumbnail.fg = ${fg}
thumbnail.bg = ${bg}
...
prompt.font = 14pt JetBrainsMono Nerd Font
prompt.fg = #282a2e
prompt.bg = #d6d6d6
prompt.padding = 2px
...
vim.api.nvim_create_user_command("MiniExport", export, {})
